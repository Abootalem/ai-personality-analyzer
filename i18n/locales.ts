...
aiDescriptionTitle: {
  ...
  "warning.apiKeyMissing": {
    en: "Warning: AI Service API Key not found. Analysis features are unavailable. Please set the API_KEY environment variable.",
    fa: "هشدار: کلید API برای سرویس هوش مصنوعی یافت نشد. قابلیت‌های تحلیل در دسترس نیستند. لطفاً متغیر محیطی API_KEY را تنظیم کنید.",
  },

  // Errors
  "error.title": { en: "Error", fa: "خطا" },
  "error.apiKeyMissing": { en: "AI Service API Key is missing. Analysis cannot be performed.", fa: "کلید API برای سرویس هوش مصنوعی وجود ندارد. تحلیل امکان‌پذیر نیست.", },
  ...
  "error.invalidApiKey": { en: "Invalid AI Service API Key. Check your configuration.", fa: "کلید API سرویس هوش مصنوعی نامعتبر است. تنظیمات خود را بررسی کنید." },
